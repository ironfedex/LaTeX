...
\begin{figure}[h!]
	\centering
	\subfloat[][]
	{\includegraphics[scale=0.4]{mfi}} \quad
	\subfloat[][]
...
\end{array}
$
\caption{Die swell values of three types of PP. See data in Appendix C}
\label{tab:dieswell}
\end{table}\\
...
\begin{figure}[htp]
	...
	\captionsetup{justification=centering}
	\caption{Hardness values comparison. For ref. data see Appendix D.}
	\label{fig:duro}
\end{figure}
