...
In Figure \ref{fig:mw} the dependency of molecular weight in function of the MFI is reported~\cite{handbook}.
\begin{figure}[h!]
	\centering
...
\bibitem{article} A review of extrudate swell in polymers - C. Sirisinha – J.Sci.Soc.Thailand 23-259-280.
