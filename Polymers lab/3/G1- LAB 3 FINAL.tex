...
\begin{figure}[h!]
	\centering
	\subfloat[][]
	{\includegraphics[scale=0.425]{dieswell}} 
	\subfloat[][]
	{\includegraphics[scale=0.14]{dieswell2}}
	\captionsetup{justification=centering}
...
\begin{table}[htp]
	...
	\begin{array}{ccc}
	\toprule
	\textbf{Temperature}\, (^\circ \text{C}) & \textbf{Intercept} & \textbf{Slope} \, (1/\text{Kg}) \\
	\midrule
...
\begin{figure}[h!]
	\centering
	\subfloat[][]
	{\includegraphics[scale=0.35]{mfimod}}
	\subfloat[][]
	{\includegraphics[scale=0.44]{mfi2}}
	\captionsetup{justification=centering}
...
\text{MW (g/mol)}\cdot 10^{-3} & 174 & 236 & 142 \\
\bottomrule
\end{array}
$
...
\bibitem{swell} A review of extrudate swell in polymers - C. Sirisinha – J.Sci.Soc.Thailand 23-259-280, 1997.
...
\begin{table}[htp]
	...
	\end{tabular}
	$
	\caption{Melt flow index values (g/10 min) for PP-1 and standard deviations ati different load (kg) and temperature ($^\circ$C)}
	\label{tab:tmwpp}
\end{table}
