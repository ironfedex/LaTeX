data1 = importdata("!^PME2019G1 PET tt L=72,3.txt");

data2 = importdata("!^PME2019G1 PET tq L=71,5.txt");
...
line(T1(e:end),w1(e:end)+0.3,'LineWidth',1,'Color',[0.8500, 0.3250, 0.0980],'LineWidth',1, ...
    'DisplayName','PET tt','LineStyle','-.')
line(T2(e:end),w2(e:end),'LineWidth',1,'DisplayName','PET','Color',[0.4660, 0.6740, 0.1880])
ylim([-1.6 2]);
yticks([])
xlim([0 300])
pos = get(g, 'Position');
