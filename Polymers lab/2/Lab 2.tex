...
\begin{table}[htp]
	...
	\midrule
	\text{High density polyethylene (PE)} & 0.95 & \text{-}110 & 138 & -\\
	\\
	\text{Polystyrene (PS)} & 1.04^{(a)} & 100 & - & 86.54  \\
	& 1.11 ^{(c)} & & & \\
	\text{Polypropylene (PP)} & 0.85 ^{(a)} & \text{-}10  & 165  & 209\\
	& 0.94 ^{(c)} & & & \\
	\text{Polyethylene terephthalate (PET)} & 1.33 ^{(a)} & 70 & 265 & 140 \\
	& 1.51 ^{(c)} & & & \\
	\text{Polylactic acid (PLA)} & 1.21 ^{(a)} & 50 & 140 & 93.65\\
	& 1.30 ^{(c)} & & & \\
	\text{Polymethyl methacrylate (PMMA)} & 1.18 & 105  & - & -\\
	\bottomrule
	\end{array}
	$
	\caption{Some properties of used materials where: \\ (a) 100\% amorphous and (c) 100\% crystalline.}
	\label{tab:tgtm}
\end{table}\\
