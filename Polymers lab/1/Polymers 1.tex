...
In Table \ref{tab:compos} the compositions of spheroids used for the calculations are reported.
\begin{table}[htp]
\centering
$
\begin{array}{lccc}
...
\midrule
\mathbf{m_{PMMA}}\,(\text{g}) & 20.62 & 21.66 & 8.69 \\
\mathbf{m_{BaSO_4}}\,(\text{g}) & 3.18 & 3.34 & 1.34 \\
\mathbf{m_{BPO}}\,(\text{g}) & 0.66 & 0.70 & 0.28 \\
\mathbf{m_{MMA}}\,(\text{g}) & 8.35 & 10.73 & 3.55 \\
\mathbf{m_{HEMA}}\,(\text{g}) & - & 2.74 & - \\
\mathbf{m_{activator}}\,(\text{g}) & 0.075 & 0.08 & 0.03 \\
\mathbf{m_{stabilizer}}\,(\text{ppm}) & 46.88 & 49.3 & 19.76 \\
\midrule
\mathbf{m_{spheroid}}\,(\text{g}) & 32.89 & 39.23 & 13.90 \\
\bottomrule
\end{array}
$
